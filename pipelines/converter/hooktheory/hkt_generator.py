import pipelines.converter.hooktheory.json_chord_to_roman as json_chord_to_roman
import json
import codecs
...
def createChordJSON(chordJSON):
	...
	start_beat = (chordJSON["beat"]-1)%4+1
...
class HKTObject:
	def __init__(self, filepath):
		...
		if JSON:
			...
			self.beat_per_measure = song["meters"][0]["numBeats"]
